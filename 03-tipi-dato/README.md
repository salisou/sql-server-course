...
## Obiettivo
INT, DECIMAL, CHAR/VARCHAR, NCHAR/NVARCHAR, DATE/TIME/DATETIME2, BIT, conversioni.
...
## Esercizio
Applicare Tipi di dato a Studenti, Corsi o Iscrizioni e documentare query, risultato atteso e verifica.
