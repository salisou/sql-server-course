...
## Obiettivo
CREATE/ALTER/DROP TABLE, IDENTITY, PK, FK, UNIQUE, CHECK, DEFAULT.
...
## Esercizio
Applicare Tabelle a Studenti, Corsi o Iscrizioni e documentare query, risultato atteso e verifica.
