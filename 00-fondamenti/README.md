...
## Obiettivo
SQL Server, Database Engine, SSMS, T-SQL, istanze, connessioni e primo script.
...
## Esercizio
Applicare Fondamenti a Studenti, Corsi o Iscrizioni e documentare query, risultato atteso e verifica.
